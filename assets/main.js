...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 1000, intensity: 6, delay: 250, replay: false });
		onvisible.add('form.style1', { style: 'fade-in', speed: 1000, intensity: 4, delay: 500, replay: false });
		onvisible.add('.container.style1', { style: 'fade-in', speed: 500, intensity: 2, delay: 0, replay: false });
		onvisible.add('.container.style2', { style: 'fade-in', speed: 500, intensity: 2, delay: 0, replay: false });
